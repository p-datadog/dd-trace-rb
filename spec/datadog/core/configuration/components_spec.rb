  ...
  describe '#shutdown!' do
    ...
    context 'given no replacement' do
      ...
      it 'shuts down all components' do
        ...
        expect(components.debugging).to receive(:shutdown!) unless components.debugging.nil?
    ...
    context 'given a replacement' do
      shared_context 'replacement' do
        ...
        let(:debugging) { instance_double(Datadog::Debugging::Component) }
        ...
        before do
          ...
          allow(replacement).to receive(:debugging).and_return(debugging)
